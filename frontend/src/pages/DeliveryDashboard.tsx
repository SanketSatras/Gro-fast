                    ...
                    <div className="flex items-center gap-2 sm:gap-4">
                        ...
                        >
                            ...
                            <div className="flex flex-col justify-center">
                                <p className="text-[5.5px] sm:text-[7.5px] font-bold text-slate-400 uppercase tracking-[0.15em] sm:tracking-[0.2em] leading-none mb-0.5 sm:mb-1">Delivery Partner</p>
                                <p className="text-[8.5px] sm:text-[11px] font-black text-slate-800 leading-none tracking-wide truncate max-w-[50px] sm:max-w-none">{user?.name || 'Driver'}</p>
                            </div>
                        </Link>
                        
                        <button 
                            onClick={handleLogout} 
                            className="p-2 sm:p-3 rounded-xl sm:rounded-2xl bg-slate-50 text-slate-400 hover:text-red-500 hover:bg-red-50 transition-all shrink-0"
                        >
